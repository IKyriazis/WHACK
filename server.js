...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/www.wrexenter.online/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/www.wrexenter.online/cert.pem', 'utf8');
const ca = fs.readFileSync('/etc/letsencrypt/live/www.wrexenter.online/chain.pem', 'utf8');
